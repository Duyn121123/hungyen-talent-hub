      ...
      <Card className="bg-gradient-to-br from-card to-muted/20">
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle>Phân tích CV với AI</CardTitle>
              <CardDescription>
                Sử dụng AI để phân tích CV của bạn với JD tuyển dụng và đề xuất kỹ năng cần học
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="upload" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="upload">Tải CV & JD</TabsTrigger>
            ...
            <TabsContent value="upload" className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  <p className="text-sm text-muted-foreground">Hoặc chọn mẫu JD có sẵn:</p>
            ...
            <TabsContent value="analyze" className="space-y-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Sẵn sàng phân tích</h3>
                  <p className="text-muted-foreground mb-6">
                    AI sẽ so sánh CV của bạn với yêu cầu công việc và đưa ra các đề xuất cụ thể
                  </p>
                </div>
            ...
            <TabsContent value="results">
              {analysisResult ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Chưa có kết quả phân tích</h3>
                  <p className="text-muted-foreground mb-4">
                    Vui lòng tải lên CV và thực hiện phân tích để xem kết quả
                  </p>
                </div>
              )}
            </TabsContent>
